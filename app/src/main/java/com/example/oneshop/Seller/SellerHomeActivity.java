...
public class SellerHomeActivity extends AppCompatActivity {
    CardView CV_ViewProduct, CV_UpdateProduct, CV_DeleteProduct, CV_InsertProduct;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CV_ViewProduct = findViewById(R.id.cv_viewOrders);
        ...
        CV_ViewProduct.setOnClickListener(v -> {
            Toast.makeText(SellerHomeActivity.this, "View Product", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(SellerHomeActivity.this, SellerProductView.class);
